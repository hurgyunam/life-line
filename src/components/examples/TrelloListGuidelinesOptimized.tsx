...
interface TrelloListGuidelinesOptimizedProps {
  initialCards?: Card[]
}

export function TrelloListGuidelinesOptimized({ initialCards = [] }: TrelloListGuidelinesOptimizedProps) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-4">
      <h2 className="text-xl font-bold mb-4">Guidelines 스타일 + 최적화 (중간 버전)</h2>
      <DndContext
        sensors={sensors}
...
function SortableCard({ card }: SortableCardProps) {
  ...
  // GuidelinesStyle 구조 + WithButtons 최적화 적용
  return (
    <div
      ref={setNodeRef}
      style={style}
